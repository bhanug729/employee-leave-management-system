...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleLeaveNotFound(LeaveNotFoundException ex) {
        log.error("Leave application not found: {}", ex.getMessage());
    ...
    public ResponseEntity<ErrorResponse> handleInvalidState(InvalidLeaveStateException ex) {
        log.error("Invalid leave state transition: {}", ex.getMessage());
        return build(HttpStatus.BAD_REQUEST, ex.getMessage());
    }

    @ExceptionHandler(EmployeeServiceUnavailableException.class)
    public ResponseEntity<ErrorResponse> handleServiceUnavailable(EmployeeServiceUnavailableException ex) {
